...
@section('content')
  ...
  <form action="{{ route('employee.update', $employee->id) }}" method="POST">
    ...
    <div class="form-group">
      ...
      <input type="text" value="{{ $employee->full_name }}" id="full_name" name="full_name" class="form-control"
    ...
    <div class="form-group">
      ...
      <input type="date" value="{{ $employee->date_of_birth }}" id="date_of_birth" name="date_of_birth"
        class="form-control" required>
    </div>
    <div class="form-group">
      <label for="city">City</label>
      <input type="text" value="{{ $employee->city }}" id="city" name="city" class="form-control" required
        minlength="3" maxlength="50">
    </div>
    <div class="form-group">
      <label for="position">Position</label>
      <input type="text" value="{{ $employee->position }}" id="position" name="position" class="form-control" required
        minlength="3" maxlength="50">
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
      ...
      <input type="date" value="{{ $employee->hired_at }}" id="hired_at" name="hired_at" class="form-control"
        required>
    </div>
    <div class="form-group">
      <label for="vacation_start_count_at">Start counting for vacation at</label>
      <input type="month" value="{{ substr($employee->vacation_start_count_at, 0, -3) }}" id="vacation_start_count_at"
