                        ...
                        <div class="card-body">
                            <form action="{{ route('employee.store') }}" method="POST">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" value="{{ old('full_name') }}" id="full_name" name="full_name"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="date" value="{{ old('date_of_birth') }}" id="date_of_birth"
                                        name="date_of_birth" class="form-control" required>
                                </div>
                                <div class="form-group">
                                    <label for="city">City</label>
                                    <input type="text" value="{{ old('city') }}" id="city" name="city"
                                        class="form-control" required minlength="3" maxlength="50">
                                </div>
                                <div class="form-group">
                                    <label for="position">Position</label>
                                    <input type="text" value="{{ old('position') }}" id="position" name="position"
                                        class="form-control" required minlength="3" maxlength="50">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="date" value="{{ old('hired_at') ? old('hired_at') : date('Y-m-d') }}"
                                        id="hired_at" name="hired_at" class="form-control" required>
                                </div>
                                <div class="form-group">
                                    <label for="vacation_start_count_at">Start counting for vacation at</label>
                                    <input type="month" value="{{ old('vacation_start_count_at') }}"
